...
* [Spring Boot Testcontainers support](https://docs.spring.io/spring-boot/3.5.9/reference/testing/testcontainers.html#testing.testcontainers)
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/3.5.9/specification/configuration-metadata/annotation-processor.html)
...
* [Prometheus](https://docs.spring.io/spring-boot/3.5.9/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
