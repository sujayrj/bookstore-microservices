package dev.jeppu.web.exception;

import dev.jeppu.domain.ProductNotFoundException;
import java.net.URI;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleGenericException(Exception exception) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, "Internal Server Error");
